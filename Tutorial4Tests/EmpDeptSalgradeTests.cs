...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnAllSalesmen()
    {
        ...
        List<Emp> result = emps.Where(e => e.Job.Equals("SALESMAN")).ToList();
    ...
    public void ShouldReturnDept30EmpsOrderedBySalaryDesc()
    {
        ...
        List<Emp> result = emps.Where(e => e.DeptNo.Equals(30)).OrderByDescending(e => e.Sal).ToList(); 
    ...
    public void ShouldReturnEmployeesFromChicago()
    {
        ...
        List<Emp> result = emps.Where(e => e.DeptNo.Equals(depts.Where(e => e.DName == "CHICAGO"))).ToList(); 
    ...
    public void ShouldSelectNamesAndSalaries()
    {
        ...
        var result = emps.Select(e => (e.EName, e.Sal)).ToList(); 
    ...
    public void ShouldJoinEmployeesWithDepartments()
    {
        ...
        var result = emps.Join(depts, emp => emp.DeptNo, dept => dept.DeptNo, (emp, dept) => new { emp.EName, dept.DName}).ToList(); 
    ...
    public void ShouldMatchEmployeeToSalaryGrade()
    {
        ...
        var result = emps
            .Join(grades, 
                emp => true,
                salgrade => true,
                (emp, salgrade) => new { emp, salgrade })
            .Where(x => x.emp.Sal >= x.salgrade.Losal && x.emp.Sal <= x.salgrade.Hisal)
            .Select(x => new 
            {
                x.emp.EName,
                x.salgrade.Grade
    ...
    public void ShouldReturnEmployeesEarningMoreThanDeptAverage()
    {
        ...
        var result = emps.Where(
            emp1 => emp1.Sal > emps.Where(emp2 => emp1.DeptNo == emp2.DeptNo).Average(sal => sal.Sal)
